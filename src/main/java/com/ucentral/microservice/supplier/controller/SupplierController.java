package com.ucentral.microservice.supplier.controller;
...
public class SupplierController {
  ...
  @PostMapping
  public ResponseEntity<?> postEndpoint(@RequestBody @Valid SupplierDto request) {
    return ResponseEntity.ok(
  ...
  @PutMapping("/{id}")
  public ResponseEntity<?> putEndpoint(@PathVariable @Positive Long id, @RequestBody @Valid SupplierDto request) {
    return ResponseEntity.ok(
